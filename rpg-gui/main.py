...
background = tk.PhotoImage(file="back.png")
sprite_pic = tk.PhotoImage(file="player.png")
boss_pic = tk.PhotoImage(file="orc.png")
fire_pic = tk.PhotoImage(file="fire.png")
lightning_pic = tk.PhotoImage(file="lightning2.png")
win_pic = tk.PhotoImage(file="WIN.png")
lose_pic = tk.PhotoImage(file="LOSE.png")
